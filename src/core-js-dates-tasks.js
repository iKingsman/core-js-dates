...
function getCountDaysOnPeriod(dateStart, dateEnd) {
  const startDateTimestamp = new Date(dateStart).getTime();
  const endDateTimestamp = new Date(dateEnd).getTime();
  return (endDateTimestamp - startDateTimestamp) / 1000 / 60 / 60 / 24 + 1;
}
